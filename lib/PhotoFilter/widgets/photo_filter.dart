            ...
            FlatButton(
              ...
              onPressed: () {
                print(
                    "//////////////////////////////////////////////////////////////////////////////////");
                print(bright);
                stdout.write("Brightness = $bright");
          ...
          loading
              ...
              : IconButton(
                  ...
                  onPressed: () async {
                    ...
                    //     800, 800, imageFile.readAsBytesSync());
                    // print(
                    //     "1111111111111111111111111111111111111111111111111111111111111111111111111111111111111");
                    // print(bitmap);
                    // Bitmap bright = bmp.brightness(bitmap, 0.3);
                    // print(bright);
                    // Uint8List headedBitmap = bright.buildHeaded();
                    // //var img = Image.memory(headedBitmap);
                    // var img = imageLib.decodeImage(headedBitmap);

                    // var ig = imageLib.adjustColor(img, brightness: 1.5);
  ...
  _buildFilterThumbnail(Filter filter, imageLib.Image image, String filename) {
    if (cachedFilters[filter?.name ?? "_"] == null) {
      return FutureBuilder<List<int>>(
        future: compute(applyFilter, <String, dynamic>{
          "filter": filter,
          "image": imageLib.adjustColor(image, brightness: 50),
          "filename": filename,
        }),
        builder: (BuildContext context, AsyncSnapshot<List<int>> snapshot) {
          switch (snapshot.connectionState) {
