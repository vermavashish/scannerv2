...
class AddictiveRedFilter extends ColorFilter {
  AddictiveRedFilter(double bright) : super(name: "AddictiveRed") {
    subFilters.add(new AddictiveColorSubFilter(50, 0, 0));
    subFilters.add(new ContrastSubFilter(.1));
    subFilters.add(new SaturationSubFilter(bright));
  }
}

class AddictiveBlueFilter extends ColorFilter {
  AddictiveBlueFilter(double bright) : super(name: "AddictiveBlue") {
...
List<Filter> presetFiltersList = [
  NoFilter(),
  AddictiveBlueFilter(0.0),
  AddictiveRedFilter(0.0),
  // AdenFilter(),
  // AmaroFilter(),
  // AshbyFilter(),
  // BrannanFilter(),
